...
namespace Nshp\LaravelSession\Middleware;

use Closure;
use Illuminate\Contracts\Session\Session;
use Illuminate\Http\Request;
use Illuminate\Routing\Route;
use Nshp\LaravelSession\SessionManager;
...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \Nshp\LaravelSession\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \Nshp\LaravelSession\SessionManager  $manager
